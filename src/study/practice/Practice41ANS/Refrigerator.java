...
//	- 문이 몇개인지
	...
	//refri.upTemperature()
	//refri.currentTemperature
	public void upTemperature() {
		if(currentTemperature<maxTemperature)currentTemperature++;//온도 1도 올리기
	}
	...
	public void downTemperature() {
		if(currentTemperature>minTemperature)currentTemperature--;//온도 1도 내리기
	}
	//온도 조절(매개변수)
	...
	public void controllTemperature(int temp) {
		if(currentTemperature+temp<=maxTemperature&&currentTemperature+temp>=minTemperature)
